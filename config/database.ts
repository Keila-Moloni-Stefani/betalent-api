...
const dbConfig = defineConfig({
   ...
   * Para o desafio, usamos MySQL (Docker), mas
   * permitimos sobrescrever via DB_CONNECTION.
   */
  connection: env.get('DB_CONNECTION', 'mysql'),

  connections: {
    /**
     * SQLite connection (útil para testes locais).
     */
    sqlite: {
    ...
    mysql: {
      ...
      connection: {
        ...
        user: env.get('DB_USER', 'betalent'),
        password: env.get('DB_PASSWORD', 'betalent'),
